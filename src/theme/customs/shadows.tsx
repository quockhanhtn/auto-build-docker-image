...
const LIGHT_MODE = ColorCons.Grey[500];
...
const createCustomShadow = (color: string) => {
  ...
  return {
    ...
    primary: `0 8px 16px 0 ${alpha(ColorCons.Primary.main, 0.24)}`,
    secondary: `0 8px 16px 0 ${alpha(ColorCons.Secondary.main, 0.24)}`,
    info: `0 8px 16px 0 ${alpha(ColorCons.Info.main, 0.24)}`,
    success: `0 8px 16px 0 ${alpha(ColorCons.Success.main, 0.24)}`,
    warning: `0 8px 16px 0 ${alpha(ColorCons.Warning.main, 0.24)}`,
    error: `0 8px 16px 0 ${alpha(ColorCons.Error.main, 0.24)}`,
  };
};
